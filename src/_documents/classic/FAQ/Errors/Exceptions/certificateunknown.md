...
 [FAQ](/FAQ/index.md) > [Errors](../../../FAQ/errors.md) > [Exceptions](../../../FAQ/Errors/exceptions.md) > [certificate_unknown](../../../FAQ/Errors/Exceptions/certificateunknown.md)
...
Make sure that you exported the broker's certificate (step 2 in [How do I use SSL](../../../FAQ/Using Apache ActiveMQ/how-do-i-use-ssl.md)) and imported it on the client into a truststore (step 4). If you did those, did you specify the javax.net.ssl.trustStore system property when you started your client VM?
