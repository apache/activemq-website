...
[Features](../../features.md) > [Message Dispatching Features](../../Features/message-dispatching-features.md) > [Total Ordering](../../Features/Message Dispatching Features/total-ordering.md)
