...
[Site](../../../site.md) > [Old Links](../../../Site/old-links.md) > [Previous Versions](../../../Site/Old Links/previous-versions.md) > [Advisory Support in ActiveMQ 3](../../../Site/Old Links/Previous Versions/advisory-support-in-activemq-3.md)

For users of Apache ActiveMQ 4.0 or later please see [Advisory Message](/Features/Message Features/advisory-message.md "Advisory Message"). In previous 3.x versions the following is supported:-
