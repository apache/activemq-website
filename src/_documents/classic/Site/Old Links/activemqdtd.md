...
[Site](../../site.md) > [Old Links](../../Site/old-links.md) > [activemq.dtd](../../Site/Old Links/activemqdtd.md)

We support a custom [Xml Configuration](xml-Community/FAQ/configuration.md "Xml Configuration") mechanism for configuring a Message Broker instance.
...
Even though we're using a DTD we still support custom extension of the XML via the Spring _<bean>_ and _<property>_ tags.
