...
[Site](site.md) > [Old Links](SiteSite/Site/old-links.md) > [Previous Versions](Site/Old LinksSite/Old Links/Site/Old Links/previous-versions.md) > [Running a 3.x Broker](Site/Old Links/Previous VersionsSite/Old Links/Previous Versions/Site/Old Links/Previous Versions/running-a-3x-broker.md)
...
You can use the [Xml Configuration](xml-Community/FAQ/configuration.md "Xml Configuration") to customize the Message Broker to suit your needs. You can run a broker from Maven as follows...
