...
[Community](community.md) > [FAQ](CommunityCommunity/Community/faq.md) > [General](Community/FAQ/general.md) > [How can I get the source code from subversion](Community/FAQ/GeneralCommunity/FAQ/General/Community/FAQ/General/how-can-i-get-the-source-code-from-subversion.md)
...
To then build the code, see [Building](Developers/building.md).
...
**Committers:** Please follow the instructions for properly configuring the [Instructions for Core Contributors/Hacking Guide](https://github.com/apache/activemq-artemis/blob/master/docs/hacking-guide/enSUMMARY.md)
...
To then build the code, take a look at [Building the distribution](https://github.com/apache/activemq-artemis/blob/master/docs/hacking-guide/enDevelopers/Developers/building.md)
