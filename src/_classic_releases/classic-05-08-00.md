...
type: classic
redirect_from:
- /components/classic/download/activemq-580-release
---

[Overview](overview) > [Download](download) > [ActiveMQ Classic 5.8.0 Release](activemq-580-release)
...
Also see the previous [ActiveMQ Classic 5.7.0 Release](activemq-570-release)
