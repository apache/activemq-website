...
type: classic
redirect_from:
- /components/classic/download/activemq-5133-release
---

[Overview](overview) > [Download](download) > [ActiveMQ Classic 5.13.3 Release](activemq-5133-release)

ActiveMQ Classic 5.13.3 Release
-----------------------
...
Also see the previous [ActiveMQ Classic 5.13.2 Release](activemq-5132-release)
