...
type: classic
redirect_from:
- /components/classic/download/activemq-532-release
---

[Overview](overview) > [Download](download) > [ActiveMQ Classic 5.3.2 Release](activemq-532-release)
...
Also see the previous [ActiveMQ Classic 5.3.1 Release](activemq-531-release)
