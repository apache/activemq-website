...
ActiveMQ 6 modernizes the ActiveMQ 5 broker engine to support new JDK releases and provide support for Jakarta EE. This includes support for JMS 2.0 APIs that are available in Jakarta Messaging 3.1.
