...
ActiveMQ supports some JMS defined properties, as well as some ActiveMQ ones - see [message properies](activemq-classic-message-properties) \- that the selector can use.
