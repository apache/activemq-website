...
 [FAQ](faq) > [General](general) > [How does ActiveMQ compare to Mule](how-does-activemq-classic-compare-to-mule)
...
Both Mule and ActiveMQ have commercial support available from companies dedicated to the technologies. Commercial support options for ActiveMQ are listed [here](../../../support.md).
