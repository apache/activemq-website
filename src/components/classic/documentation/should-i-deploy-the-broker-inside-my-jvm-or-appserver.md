...
 [FAQ](faq) > [Using Apache ActiveMQ](using-apache-activemq-classic) > [Should I deploy the broker inside my JVM or AppServer](should-i-deploy-the-broker-inside-my-jvm-or-appserver)
