...
[Features](../../features.md) > [Consumer Features](../../Features/consumer-features.md) > [Exclusive Consumer](../../Features/Consumer Features/exclusive-consumer.md)
...
An Exclusive Consumer is created using [Destination Options](../../Features/Destination Features/destination-options.md) as follows:
