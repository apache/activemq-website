...
[Site](site.md) > [Old Links](SiteSite/Site/old-links.md) > [ActiveSoap](Site/Old LinksSite/Old Links/Site/Old Links/activesoap.md)
...
*   is XMLBeans definitely the fastest stack we can use? XStream is pretty fast though its java centric rather than XSD centric (but maybe thats a good thing ![](https://cwiki.apache.org/confluence/images/icons/emoticons/smile.gif)
