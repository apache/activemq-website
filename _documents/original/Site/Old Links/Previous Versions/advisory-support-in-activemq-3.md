...
[Site](site.md) > [Old Links](SiteSite/Site/old-links.md) > [Previous Versions](Site/Old LinksSite/Old Links/Site/Old Links/previous-versions.md) > [Advisory Support in ActiveMQ 3](Site/Old Links/Previous Versions/advisory-support-in-activemq-3.md)

For users of Apache ActiveMQ 4.0 or later please see [Advisory Message](Features/Message FeaturesFeatures/Message Features/Features/Message Features/advisory-message.md "Advisory Message"). In previous 3.x versions the following is supported:-
...
<!\[CDATA\[ ActiveMQDestination.CONSUMER\_ADVISORY\_PREFIX ActiveMQDestination.PRODUCER\_ADVISORY\_PREFIX ActiveMQDestination.CONNECTION\_ADVISORY\_PREFIX ActiveMQDestination.TEMP\_DESTINATION\_ADVISORY_PREFIX \]\]>
