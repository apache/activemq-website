...
[Features](features.md) > [Persistence](Features/persistence.md) > [KahaDB](Features/PersistenceFeatures/Persistence/Features/Persistence/kahadb.md)
...
For tuning locking properties see the options listed at [Pluggable storage lockers.](Features/PersistenceFeatures/Persistence/Features/Persistence/pluggable-storage-lockers.md)
