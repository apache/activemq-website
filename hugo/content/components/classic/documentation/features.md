...
Apache ActiveMQ is packed with features. See the [Features Overview](../features-overview) for a summary, or browse the full list below.

### Clustering & High Availability

- [MasterSlave](../masterslave) — [JDBC Master Slave](../jdbc-master-slave), [Shared File System Master Slave](../shared-file-system-master-slave), [Pure Master Slave](../pure-master-slave)
